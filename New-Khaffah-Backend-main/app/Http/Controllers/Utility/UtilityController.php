...
class UtilityController extends Controller
{
    ...
    /**
     * Daftar bandara Indonesia (titik keberangkatan / embarkasi) untuk form product-request & pesan tiket pesawat.
    ...
    public function getBandara()
    {
        try {
            $bandara = [
                ['value' => 'CGK', 'label' => 'CGK - Soekarno-Hatta International Airport (Jakarta/Tangerang)'],
                ['value' => 'SUB', 'label' => 'SUB - Juanda International Airport (Surabaya)'],
                ['value' => 'UPG', 'label' => 'UPG - Sultan Hasanuddin International Airport (Makassar)'],
                ['value' => 'KNO', 'label' => 'KNO - Kualanamu International Airport (Medan)'],
                ['value' => 'SOC', 'label' => 'SOC - Adi Soemarmo International Airport (Solo)'],
                ['value' => 'YIA', 'label' => 'YIA - Yogyakarta International Airport (Yogyakarta)'],
                ['value' => 'KJT', 'label' => 'KJT - Kertajati International Airport (Majalengka/Jawa Barat)'],
                ['value' => 'PDG', 'label' => 'PDG - Minangkabau International Airport (Padang)'],
                ['value' => 'PLM', 'label' => 'PLM - Sultan Mahmud Badaruddin II International Airport (Palembang)'],
                ['value' => 'BTH', 'label' => 'BTH - Hang Nadim International Airport (Batam)'],
                ['value' => 'BTJ', 'label' => 'BTJ - Sultan Iskandar Muda International Airport (Banda Aceh)'],
                ['value' => 'BDJ', 'label' => 'BDJ - Syamsudin Noor International Airport (Banjarmasin)'],
                ['value' => 'BPN', 'label' => 'BPN - Sepinggan International Airport (Balikpapan)'],
                ['value' => 'LOP', 'label' => 'LOP - Zainuddin Abdul Madjid International Airport (Lombok)'],
            ];
    ...
    /**
     * Daftar bandara tujuan (Arab Saudi) untuk form pesan tiket pesawat / umrah.
     * GET /api/utility/bandara-tujuan
     */
    public function getBandaraTujuan()
    {
        try {
            $bandara = [
                ['value' => 'JED', 'label' => 'JED - King Abdulaziz International Airport (Jeddah)'],
                ['value' => 'MED', 'label' => 'MED - Prince Mohammad bin Abdulaziz International Airport (Madinah)'],
                ['value' => 'TIF', 'label' => 'TIF - Taif Regional Airport (Taif)'],
            ];

            return response()->json([
                'status' => true,
                'message' => 'Daftar bandara tujuan berhasil diambil',
                'data' => $bandara,
            ]);
        } catch (\Throwable $th) {
            return response()->json([
